...
public class ModFrogVariants {
    ...
    private static ResourceKey<FrogVariant> createKey(String path) {
        return ResourceKey.create(Registries.FROG_VARIANT, Identifier.fromNamespaceAndPath(MOD_ID, path));
    }
    ...
    public static void bootstrap(BootstrapContext<FrogVariant> bootstrapContext) {
        ...
        bootstrapContext.register(ModFrogVariants.DARK, new FrogVariant(new ClientAsset.ResourceTexture(Identifier.fromNamespaceAndPath(MOD_ID, "entity/frog/dark_frog")), spawnPrioritySelectors));
    }
}
